...
const Content = ({
    ...
    let alignmentClasses = 'origin-top';  // Default to "down"

    if (align === 'bottom') {
        alignmentClasses = 'origin-bottom';  // Open downwards
    } else if (align === 'top') {
        alignmentClasses = 'origin-top bottom-full';  // Open upwards above the button
    } else if (align === 'left') {
